...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Modern minimalist design specifically for built-in gas hobs. Available in ABS material.',
    image: '/Hob-series/hob-series-copper.png',
    specs: {
      shaftSize: '6 mm',
      weight: '10 gm',
      material: 'ABS',
    ...
    colorVariants: [
      ...
      },
      {
        color: '#C0C0C0',
        name: 'Silver',
        image: '/Hob-series/hob-series-silver.png',
        modelNumber: 'HB-SL',
      },
      {
        color: '#FFD700',
        name: 'Golden',
        image: '/Hob-series/hob-series-golden.png',
        modelNumber: 'HB-GL',
      },
      {
        color: '#808080',
        name: 'Grey',
        image: '/Hob-series/hob-series-grey.png',
        modelNumber: 'HB-GR',
      },
      {
        color: '#D2B48C',
        name: 'Natural',
        image: '/Hob-series/hob-series-natural.png',
        modelNumber: 'HB-NT',
      },
    ],
  },
